    ...
    public class Program
    {
        ...
        public static async Task Main()
        {
            ...
            try
            {
                ...
                Console.WriteLine("🟢 البوت يعمل الآن.");
            }
            catch (Exception ex)
            {
                Console.WriteLine(
            ...
            Message message)
        {
            if (_game != null && _game.Started)
            {
                await client.Reply(
                    message,
                    "⚠️ توجد لعبة بالونات قيد التشغيل حاليًا.");
                return;
            }
            ...
            BalloonPlayer creator =
                await CreatePlayer(client, message, 1);
            ...
            int number)
        {
            ...
            await client.Reply(
                ...
                $"{balloons}\n\n" +
                "💥 أرسل رقم البالونة التي تريد تفجيرها.");
        }
